...
PROJECT_NAME ?= provider-thousandeyes
PROJECT_REPO ?= github.com/gorositopablo/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_SOURCE := thousandeyes/thousandeyes
...
xpkg.build.provider-thousandeyes: do.build.images
